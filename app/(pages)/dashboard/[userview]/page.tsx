...
import { Banknote, ChartSpline, MoveDown, ShieldCheck } from "lucide-react";
...
export default function UserViewDetails() {
  ...
  const profileItems = [
    ...
    ["Registered", formatDate(customer.dateRegistered)],
    [
      "KYC level",
          ...
          <div className="flex items-start justify-between gap-3 border-b border-neutral-200 pb-4">
            <div>
              ...
              <p className="mt-1 text-xs text-neutral-500">
                Last login: {formatDate(customer.lastActive, true)}
              </p>
            </div>
            <Status
            ...
            <section className="rounded-lg border border-neutral-200 p-4">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3">
                <p className="flex items-center gap-2 text-2xl font-semibold text-neutral-black">
                  <ChartSpline className="size-4 text-green-primary" />
              ...
              <div className="mt-5 flex flex-wrap gap-x-3 gap-y-1 text-xs text-neutral-500">
                ...
                <span>{formatDate(customer.lastDeposit?.date ?? null)}</span>
              </div>
            </section>
            <section className="rounded-lg border border-neutral-200 p-4">
              <div className="flex items-center gap-2 text-neutral-500">
